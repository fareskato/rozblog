    ...
    <div id="address_wrapper">
        ...
        <div id="cart_addresses">
            ...
            <h2>
                ...
                <a class="h2-link button" href="<?php echo $add_url; ?>"><?php _e('Add New', 'wc_shipping_multiple_address'); ?></a>
            </h2>
		                ...
		                <div class="account-address">
                            ...
                            if ( isset($addr['default_address']) && $addr['default_address'] ) {
                                if (function_exists('wc_get_endpoint_url'))
                                    echo '<a href="'. wc_get_endpoint_url( 'edit-address', 'shipping', get_permalink(woocommerce_get_page_id( 'myaccount' )) ) .'" class="button edit">'. __( 'edit', 'wc_shipping_multiple_address' ) .'</a>';
                                else
                                    echo '<a href="'. esc_url( add_query_arg('address', 'shipping', get_permalink(woocommerce_get_page_id( 'edit_address' ) ) ) ) .'" class="button edit">'. __( 'edit', 'wc_shipping_multiple_address' ) .'</a>';
                            } else {
                        ...
                        <div class="account-address">
                            ...
                            <ul class="items-column" id="items_column_<?php echo $addr_id; ?>">
                                ...
                                <li data-product-id="<?php echo $value['product_id']; ?>" data-key="<?php echo $key; ?>" class="address-item address-item-<?php echo $value['product_id']; ?> address-item-key-<?php echo $key; ?>">
                                    ...
                                    <?php echo $woocommerce->cart->get_item_data( $value ); ?>
                                    <input type="hidden" name="items_<?php echo $addr_id; ?>[]" value="<?php echo $key; ?>">
                                    <a class="remove" href="#"><img style="width: 16px; height: 16px;" src="<?php echo plugins_url('images/delete.png', __FILE__); ?>" class="remove" title="<?php _e('Remove', 'wc_shipping_multiple_address'); ?>"></a>
                                </li>
                                <?php
                                        }
                                    }
