<div class="col-lg-12">
    <form method="post" action="" id="address_form">
        ...
        <div>
            <a class="button" href="<?php echo $add_url; ?>"><?php _e('Add a new shipping address', 'wc_shipping_multiple_address'); ?></a>
            ...
            if ( isset($ms_settings['cart_duplication']) && $ms_settings['cart_duplication'] != 'no' ):
                ...
                <div style="float: right;">
                    <a class="h2-link button" href="<?php echo $dupe_url; ?>"><?php _e('Duplicate Cart', 'wc_shipping_multiple_address'); ?></a>
        ...
        <table class="shop_table cart" cellspacing="0">
            <thead>
            <tr>
                <th class="product-name" style="width: auto;"><?php _e( 'Product', 'woocommerce' ); ?></th>
            ...
            foreach ($contents as $key => $value):
                ...
                for ( $x = 0; $x < $value['quantity']; $x++ ):
                    ...
                    <tr>
                        ...
                        <td><input type="submit" name="delete_line" class="button delete-line-item" data-key="<?php echo $key; ?>" data-index="<?php echo $x; ?>" value="<?php _e('Delete'); ?>" /></td>
                    </tr>
                <?php
                endfor;
            endforeach;
        ...
        <div class="form-row">
            ...
            <div class="update-shipping-addresses">
                <input type="submit" name="update_quantities" class="button white-button" value="<?php _e('Update'); ?>" />
            </div>

            <div class="set-shipping-addresses">
                <input class="button alt pink-button" type="submit" name="set_addresses" value="<?php echo __('Save Addresses and Continue', 'wc_shipping_multiple_address'); ?>" />
            </div>
