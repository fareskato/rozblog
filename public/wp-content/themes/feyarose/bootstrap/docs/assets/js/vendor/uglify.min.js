(function (exports, global) {
        ...
        var statement = embed_tokens(function () {
            ...
            switch (S.token.type) {
                case"string":
                    ...
                    if (dir && stat.body instanceof AST_String && !is("punc", ","))return new AST_Directive({value: stat.body.value});
                    return stat;
                case"num":
                case"regexp":
                case"operator":
        ...
        OPT(AST_Conditional, function (self, compressor) {
            ...
            if (consequent instanceof AST_Conditional && consequent.alternative.equivalent_to(alternative)) {
                return make_node(AST_Conditional, self, {
                    ...
                    }), consequent: consequent.consequent, alternative: alternative
                })
            }
            return self
        });
    ...
    (function () {
        var MOZ_TO_ME = {
            ...
            }, UnaryExpression: From_Moz_Unary, UpdateExpression: From_Moz_Unary, Identifier: function (M) {
