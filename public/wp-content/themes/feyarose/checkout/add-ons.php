 ...
 *
 * @package   WC-Checkout-Add-Ons/Templates
 * @author    SkyVerge
 ...
 *
 * @param array $add_on_fields add-on fields to be rendered by woocommerce_form_field
 *
 * @version 1.0
 * @since 1.0
 */
...
<div id="wc_checkout_add_ons" class="col-lg-12">
	<?php
//    echo "<pre>";
//    print_r($add_on_fields);
//    echo "</pre>";
