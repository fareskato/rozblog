			...
			<?php
				...
				if ( $metadata = $order->has_meta( $item_id ) ) {
					...
					foreach ( $metadata as $meta ) {
                        ...
                        $metakey = rawurldecode( $meta['meta_key'] ) ;
                        $metakey = feyarose_getCleanNameOfProductAddon($meta['meta_key'], true);
						echo '<tr><th>' .$metakey . ':</th><td>' . wp_kses_post( wpautop( make_clickable( rawurldecode( $meta['meta_value'] ) ) ) ) . '</td></tr>';
					}
					echo '</table>';
				}
			?>
